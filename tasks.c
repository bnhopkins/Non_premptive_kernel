...
static struct task_info task1 =
    { (uint32_t) & clock_thread, KERNEL_THREAD };
...
static struct task_info time_switch_1 =
    { (uint32_t) & thread4, KERNEL_THREAD };
static struct task_info time_switch_2 =
    { (uint32_t) & thread5, KERNEL_THREAD };
static struct task_info time_switch_3 = { PROC3_ADDR, PROCESS };
static struct task_info *task[] =
    { &task1, &task2, &task3, &task4, &task5, &time_switch_1,
    &time_switch_2, &time_switch_3, &time_switch_3,     /* Yes, the duplication is intentional */
};
// static struct task_info *task[] = { &time_switch_1,  &time_switch_2};
// static struct task_info *task[] = { &task5 };
